      ...
      <Modal
        ...
        >
          ...
          <Modal.Body>
            ...
            <p>
              {props.descripcion}
              <Card.Img variant="top" src={props.imagenes?(props.imagenes):("https://via.placeholder.com/320x320")} />
            </p>
          </Modal.Body>
          <Modal.Footer>
        ...
        <div>
            <Container>
                <Card style={{ width: '18rem' }}>
                        <Card.Img variant="top" src={imagenes?(imagenes):("https://via.placeholder.com/320x320")}/>
                        <Card.Body>
